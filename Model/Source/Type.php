...
namespace Orangecat\CspWhitelist\Model\Source;

use Magento\Eav\Model\Entity\Attribute\Source\AbstractSource;

class Type extends AbstractSource
{
    private const SOURCE_DEFAULT = 'default-src';

    private const SOURCE_BASE = 'base-uri';

    private const SOURCE_CHILD = 'child-src';

    private const SOURCE_CONNECT = 'connect-src';

    private const SOURCE_FONT = 'font-src';

    private const SOURCE_FORM = 'form-action';

    private const SOURCE_FRAME_ANCESTORS = 'frame-ancestors';

    private const SOURCE_FRAME = 'frame-src';

    private const SOURCE_IMG = 'img-src';

    private const SOURCE_MANIFEST = 'manifest-src';

    private const SOURCE_MEDIA = 'media-src';

    private const SOURCE_OBJECT = 'object-src';

    private const SOURCE_SCRIPT = 'script-src';

    private const SOURCE_STYLE = 'style-src';
